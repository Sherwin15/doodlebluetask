(function($) {
    ...
    function enableIsotope() {
      ...
      $('.masonry-filters').each( function( i, buttonGroup ) {
        ...
        // init isotope
        var $grid = $buttonGroup.next('.grid');
    ...
    if (($(".popup-img").length > 0) || ($(".mfp-iframe").length > 0) || ($(".mfp-img-single").length > 0)) {
        ...
        /* CreativeCloud */
        $('.ulockd_music_icon').on('click', function() {
            $('.music_icon_frame').fadeToggle('1500');
        });
    };
...
$('#contact-form').validate({
           rules: {
            ...
            messages: { 
                selects:{required:'Please choose a option'},               
                name:{required:'Please enter your first name'},
                 name2:{required:'Please enter your last name'},
                phone : {required : " Please enter valid number"},
